...
var marko_template = module.exports = require("marko/src/html").t(__filename),
    marko_componentType = "/library$1.0.0/src/app/views/books/list/show.marko",
...
function render(input, out, __component, component, state) {
  ...
  out.w("</table> <script src=\"/static/js/delete-book.js\">\r\n        </script> ");
...
marko_template.meta = {
    id: "/library$1.0.0/src/app/views/books/list/show.marko",
    tags: [
